      ...
      <Card>
        <CardContent className="p-6">
          <div className="text-center text-red-600">
            ...
            <p>Error loading inbound files: {error}</p>
          </div>
        </CardContent>
      </Card>
    );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Overview of inbound files and their processing status
        </CardDescription>
      </CardHeader>
      <CardContent>
        {loading ? (
          <div className="flex items-center justify-center p-8">
            ...
            <span className="ml-2">Loading inbound files...</span>
          </div>
        ) : (
          <>
            <Table>
              ...
              <TableBody>
                {data?.data.map((item, index) => (
                  <TableRow key={`${item.processId}-${index}`} className="hover:bg-accent/50">
